...
export const UNIT_TYPES = {
        ...
        "Pike": {
            ...
            extraSkills: [PIKE_REPAIR, PIKE_FIRE],
        ...
        "Halberd": {
            ...
            maxHp: 8,
            hp: 8,
            // 3 rather than the tank line's 2: an AA that cannot keep up
            // with what it hunts is scenery -- helicopters move 4-5, and
            // at move 2 the Halberd never contested them (measured as
            // "helicopters shoot everything apart"). One point of speed
            // makes its 1-2 range bubble something air has to route
            // around instead of ignore.
            move: 3,
            minRange: 1,
        ...
        "Kloss": {
            ...
            name: "Kloss",
            unitClass: 'tank' as const,
            // Almost pure architecture: nearly cannot die, and deals a
            // TOKEN 1 -- zero damage left the search nothing to resolve
            // around an engaged Kloss and it wandered in idiot loops
            // (measured live). One point of damage is enough for contact
            // to mean something; where it stands is still everything.
            maxHp: 99,
            hp: 99,
            move: 2,
            minRange: 1,
